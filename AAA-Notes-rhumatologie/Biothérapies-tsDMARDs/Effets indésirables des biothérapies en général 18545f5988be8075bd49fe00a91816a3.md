...
| :--- | :--- | :--- | :--- | :--- |
| **MTX** | Effet immuno-supresseur <br> Altération clairance HPV16 et 18 | **NMSC*** <br> **col utérin (HPV)** <br> Rares lymphomes EBV-dépendants | Pas de surrisque global de cancer | Dépistage cancer du col et surveillance cutanée |
| **LEF** |  | **Plutôt neutre** | Pas de surrisque global de cancer | Pas de point de vigilance |
| **SSZ** |  | **Aucun** | Pourrait être protecteur pour le côlon | Pas de point de vigilance |
***
...
* ### b) Traitements pour lesquels on manque de recul
| Classe | Explication théorique physiopath | Signal principal de risque oncologique | Données rassurantes | Points de vigilance / recommandations |
| :--- | :--- | :--- | :--- | :--- |
| **Anti-IL-6R** | L'IL-6 stimule la prolifération des cellules cancéreuses via l'activation de STAT3| Aucun signal fort ; quelques cas de lymphome évoqués | Globalement rassurant ; utilisé en oncologie (syndrome de relargage cytokinique, immunotoxicités) | Utilisable mais préférer anti-TNF |
| **Anti-IL-17/23** |  | Pas assez de recul (< 10 ans en pratique courante) | | Utilisable mais préférer Anti-TNF <br> <br> Surveillance à long terme indispensable |
***
* ### c) Traitements à éviter en cas d'ATCD de cancer ou de facteurs de risque de cancer
| Classe | Explication théorique physiopath | Signal principal de risque oncologique | Données rassurantes | Points de vigilance / recommandations |
| :--- | :--- | :--- | :--- | :--- |
| **Abatacept** | Mécanisme inverse des inhibiteurs de points de contrôle (anti-CTLA4) => inhibe la costimulation des lymphocytes T (CD80/86–CD28), ce qui peut freiner l'immunosurveillance antitumorale. | Risque global de cancer <br> NMSC ++ et mélanome | Possible surrisque de tumeurs solides surtout porté par les NMSC | Surveiller la peau  <br>  <br> **A éviter** en cas d'antécédent oncologique si des alternatives sont disponibles |
| **JAKi** | Altération de l'immunosurveillance (voies de l'interféron, nombreuses cytokines) ; peuvent notamment inhiber les fonctions des cellules NK et des lymphocytes T cytotoxiques. | **ORAL surv.** : cancers (poumon++) chez patients > 50 ans, surtout après 18 mois d'exposition ; signal confirmé par **RABBIT** en population générale et risque + élevé si > 60 ans | Études observationnelles souvent rassurantes (mais suivi court) | **Éviter** si antécédent récent de cancer  <br>  <br> Discussion pluridisciplinaire   <br> <br> Vigilance accrue après 12–18 mois |
...
* "On peut les voir une fois pour déterminer leurs facteurs de risques."
* Dépistage systématique dermatologique si :
  * Beaucoup de lésions
